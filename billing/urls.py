...
from billing.views import PayView, PayCallbackView, PayToUserView, PayToUserCallbackView, card_modal_update
from .tests import response_test


urlpatterns = [
    url(r'^pay/$', PayView.as_view(), name='pay_view'),
    url(r'^card-update/$', card_modal_update, name='card_update_view'),
